...
public class Encrypt {
    ...
    public static void main(String args[]) throws UnsupportedEncodingException {
    	...
    	System.out.println("加密:"+(parseByte2HexStr(Encrypt.encrypt(content, "qweeee"))));
    	//对加密的16进制字符串先转义成2进制字节数组  然后通过aes解密器 解密称原文
    	System.out.println("解密:"+Encrypt.decrypt(parseHexStr2Byte(parseByte2HexStr(Encrypt.encrypt(content, "qweeee"))),"qweeee"));
    }
